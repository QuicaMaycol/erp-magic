...
class _ClientesScreenState extends State<ClientesScreen> {
  ...
  Future<void> _loadClientes() async {
    ...
    try {
      var data = await _clienteService.fetchClientes(startDate: _startDate, endDate: _endDate);
  ...
  void _exportarExcel() {
    ...
    if (fileBytes != null) {
      downloadWeb(fileBytes, "clientes_erp_magic.xlsx");
    }
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Consulta todos los formularios y tickets de compra generados.',
